        ...
        <nav className="w-full bg-transparent text-gray-700 ">
            <div className="flex justify-between items-center px-6 py-4">
                ...
                <ul className="hidden md:flex justify-center md:w-full items-center gap-10 text-base font-bold">
                    <a href="/photo"><li className={`${playfair.className} hover:text-[#e9c08b] cursor-pointer transition`}>PHOTOGRAPHY</li></a>
                    <a href="/video"><li className={`${playfair.className} hover:text-[#e9c08b] cursor-pointer transition`}>FILMS</li></a>
            ...
            {menuOpen && (
                <ul className="flex flex-col items-center bg-white text-gray-700 py-4 space-y-4 md:hidden shadow-md">
                    <a href="/photo"><li className="hover:text-black cursor-pointer transition">Photography</li></a>
                     <a href="/video"><li className="hover:text-black cursor-pointer transition">Films</li></a>
